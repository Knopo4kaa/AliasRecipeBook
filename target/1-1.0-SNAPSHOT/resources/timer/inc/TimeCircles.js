...
(function($) {
    ...
    TC_Instance.prototype.checkTime = function () {
        setInterval(function () {
            this.data.timer = this.timeLeft(this);
            alert(this.data.timer);
            return this.data.timer.getSeconds();
        },1000);
    ...
    TC_Class.prototype.checkTime = function() {
        this.foreach(function(instance) {
            instance.checkTime();
        });
        return this;
